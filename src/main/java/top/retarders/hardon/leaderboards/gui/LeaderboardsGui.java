...
public class LeaderboardsGui extends Gui {
    ...
    private static final LeaderboardsModule leaderboardsModule = Services.get(LeaderboardsModule.class).get();
    ...
    public void redraw() {
        ...
        populator.accept(ItemStackBuilder.of(Material.DIAMOND_SWORD)
                ...
                .build(() -> new LeaderboardGui(this.getPlayer(), leaderboardsModule.find("most_kills")).open()));
        ...
        populator.accept(ItemStackBuilder.of(Material.GOLD_AXE)
                ...
                .build(() -> new LeaderboardGui(this.getPlayer(), leaderboardsModule.find("highest_killstreak")).open()));
        ...
        populator.accept(ItemStackBuilder.of(Material.DIAMOND)
                ...
                .build(() -> new LeaderboardGui(this.getPlayer(), leaderboardsModule.find("richest")).open()));

        populator.accept(ItemStackBuilder.of(Material.REDSTONE)
                .name("&4&lMost Deaths")
                .lore("&7Click to view the players with the most deaths")
                .build(() -> new LeaderboardGui(this.getPlayer(), leaderboardsModule.find("most_deaths")).open()));
    }
